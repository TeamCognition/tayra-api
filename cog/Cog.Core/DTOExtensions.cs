...
namespace Cog.Core
{
    ...
    public static class DTOExtensions
    {
        ...
        public static PropertyValidationError AddPropertyError<TSource, TKey>(this TSource source,
            Expression<Func<TSource, TKey>> keySelector, string errorMessage) where TSource : DTO
        {
            var propertyValidationError = new PropertyValidationError
            {
