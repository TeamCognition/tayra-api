...
namespace Tayra.Services.Analytics
{
    public class AnalyticsService : BaseService<OrganizationDbContext>, IAnalyticsService
    {
        ...
        public Dictionary<int, AnalyticsMetricWithIterationSplitDto> GetMetricsWithIterationSplit(MetricType[] metricTypes, Guid entityId, EntityTypes entityType, DatePeriod period)
        {
        ...
        public Dictionary<int, AnalyticsMetricWithBreakdownDto> GetMetricsWithBreakdown(MetricType[] metricTypes, Guid entityId, EntityTypes entityType, DatePeriod period)
        {
