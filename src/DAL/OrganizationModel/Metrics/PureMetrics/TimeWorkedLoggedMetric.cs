...
namespace Tayra.SyncServices.Metrics
{
    public class TimeWorkedLoggedMetric : PureMetric
    {
        ...
        public MetricShardWEntity Create(IEnumerable<Task> tasks, int dateId, int segmentId) => new MetricShardWEntity(tasks.Sum(x => x.TimeSpentInMinutes) ?? 0f, dateId, segmentId, this);
