    ...
    public class ProfileReportsTest
    {
        ...
        public void Test1()
        {
            ...
            using (var context = new OrganizationDbContext(options))
            {
                ...
                do
                {
                    GenerateProfileReportsDailyLoader.GenerateProfileReports(context, date, logService);
                    GenerateProfileReportsWeeklyLoader.GenerateProfileReports(context, date, logService);
                    
                    GenerateProjectReportsDailyLoader.GenerateProjectReports(context, date, logService);
                    GenerateProjectReportsWeeklyLoader.GenerateProjectReports(context, date, logService);   

                    GenerateTeamReportsDailyLoader.GenerateTeamReports(context, date, logService);
                    GenerateTeamReportsWeeklyLoader.GenerateTeamReports(context, date, logService);
