...
{
    public class GenerateTeamReportsDailyLoader : BaseLoader
    {
        ...
        public GenerateTeamReportsDailyLoader(LogService logService, CatalogDbContext catalogDb) : base(logService, catalogDb)
        {
        ...
        public static void GenerateTeamReports(OrganizationDbContext organizationDb, DateTime fromDay, LogService logService, List<ProfileReportDaily> profileReportsDaily = null)
        {
            ...
            logService.Log<GenerateTeamReportsDailyLoader>($"{reportsToInsert.Count} new reports saved to database.");
        }
